...
function CryptoPage() {
  ...
  return (
    <div>
      <Helmet>
        <title>Crypto Markets - Live Prices &amp; Data | wayb</title>
        ...
        <meta property="og:title" content="Crypto Markets - Live Prices & Data | wayb" />
        ...
        <meta name="twitter:title" content="Crypto Markets - Live Prices | wayb" />
        <meta name="twitter:description" content="Live crypto prices and market data on wayb." />
      </Helmet>
