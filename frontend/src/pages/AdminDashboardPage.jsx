    ...
    <main style={{ maxWidth: 920, margin: "30px auto", padding: 16 }}>
      ...
      >
        <button
          ...
          style={{
            background: activeSection === "create" ? "#0f766e" : "#6b7280",
          }}
        >
          Create Listing
        </button>
        <button
          ...
          style={{
            background: activeSection === "listings" ? "#0f766e" : "#6b7280",
          }}
        >
          Listings
        </button>
        <button
          ...
          style={{
            background: activeSection === "submissions" ? "#0f766e" : "#6b7280",
          }}
        >
          Pending Submissions
        </button>
      ...
      {activeSection === "submissions" ? (
        <>
          ...
          <PendingSubmissionsTable
            onApproved={() => setRefreshSignal((value) => value + 1)}
          />
        </>
      ) : null}
    </main>
