...
const { startEventsCron, stopEventsCron } = require('./modules/events/events.service');
const { startTechEventsCron, stopTechEventsCron } = require('./modules/tech-events/tech-event.service');
